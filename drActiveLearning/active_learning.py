...
class AL_Parameters():
    """Class responsible for managing the parameters that will be used"""
...
class AL_Strategy(Enum):
    """Class responsible for managing the techniques that will be used"""
...
class Metrics(Enum):
    """Class responsible for managing assessment metrics"""
...
class Results():
    """Class responsible for managing the results of the technique"""
    ...
    def save_npy(self, filename):
        # Save in npy
        np.save(filename, self.results_dict)
